...
set ::env(LD_LIBRARY_PATH) /data/tools/Vivado_HLS/2016.4/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Vivado_HLS/2016.4/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Vivado_HLS/2016.4/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Vivado_HLS/2016.4/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Vivado_HLS/2016.4/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "getClustersInCard.autotvin.dat"
	set constFileTvOut       "getClustersInCard.autotvout.dat"
	set constFileHdlTvIn     "getClustersInCard.autohdltvin.dat"
	set constFileHdlTvOut    "getClustersInCard.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
