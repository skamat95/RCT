...
if {[file isfile getClustersInCard.autotvin.dat]} {
	file delete -force getClustersInCard.autotvin.dat
}

if {[file isfile getClustersInCard.autotvout.dat]} {
	file delete -force getClustersInCard.autotvout.dat
}
